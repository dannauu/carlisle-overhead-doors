  ...
  return (
    <div className='text-center pt-5 font-medium'>
            <div className='pb-10 w-4/5 m-auto'>
                ...
                <p>Don't forget to check out <a href='https://www.clopaydoor.com/commercial-door-products' target='_blank' className='underline text-blue-500 hover:text-blue-900'>Clopay's </a>website to browse their commercial products.</p>
            </div>
